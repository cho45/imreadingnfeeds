...
next(function () {
	$.ajax({
		url      : "http://pipes.yahoo.com/pipes/pipe.run?Domain="+params.domain+"&User="+params.user+"&_id=ClxocmNe3RG0ebZpIGsPpw&_render=json",
		dataType : "jsonp", scriptCharset : "utf-8", jsonp : "_callback",
	//	data     : data.join("&"),
